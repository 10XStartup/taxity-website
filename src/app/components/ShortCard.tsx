...
export default function ShortCard() {
	return (
		<section>
			<article className="bg-lightPrimary py-4 lg:grid lg:grid-cols-2 lg:gap-4 content-center lg:px-6 lg:mx-10 md:rounded-xl mt-6">
				<div className="px-6  mt-6 text-center lg:text-start text-primary ">
					<h2 className="text-lg lg:text-3xl font-bold text-center lg:text-start ">
						Are you a driver
					</h2>
					<p className="text-xs lg:text-sm text-primary my-6 lg:my-3">
